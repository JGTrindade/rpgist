export interface Specie {
    ...
    name: playerSpecie | MonsterSpecie | MonstersOfTheMultiverseSpecie;
...
type MonstersOfTheMultiverseSpecie =
    "aarakocra"
    | "aasimar"
    | "bugbear"
    | "centaur"
...
const playerHandbookSpecies: Array<Specie> = [
    {
        type: "humanoid",
        name: "dragonborn",
        subtype: null
...
const monsterManualSpecies: Array<Specie> = [
    {
        type: "aberrations",
        name: "aboleth",
        subtype: null
...
const MonstersOfTheMultiverseSpecies: Array<Specie> = [
    {
        type: "humanoid",
        name: "aarakocra",
        subtype: null
